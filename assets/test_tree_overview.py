...
from project_init import build_tree_overview_text, validate_project_folder_path, __version__
...
class TreeOverviewTests(unittest.TestCase):
    def test_build_tree_overview_marks_newly_created_dirs(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            created_dirs = [project_folder / "01_INPUT", project_folder / "01_INPUT/02_RANH_QHC"]

            content = build_tree_overview_text(project_folder, "QHC", folder_paths, created_dirs)
    ...
    def test_build_tree_overview_marks_existing_dirs(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            content = build_tree_overview_text(project_folder, "QHC", folder_paths, [])
